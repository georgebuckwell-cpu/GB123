...
body{{font-family:var(--fb);background:var(--bg);color:var(--dark)}}
...
nav.sc{{background:rgba(253,252,250,.96);-webkit-backdrop-filter:blur(14px);backdrop-filter:blur(14px);box-shadow:0 1px 0 rgba(0,0,0,.07)}}
...
/* ── HERO ── */
#hero{{height:100vh;height:100svh;min-height:560px;position:relative;display:flex;align-items:center;justify-content:center;text-align:center;overflow:hidden}}
...
.heyebrow{{display:inline-block;font-size:.68rem;font-weight:500;letter-spacing:.22em;text-transform:uppercase;color:rgba(255,255,255,.8);background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.2);padding:.38rem 1.2rem;border-radius:100px;margin-bottom:1.6rem;-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px)}}
...
.aimg-main{{width:100%;height:480px;aspect-ratio:4/5;object-fit:cover;border-radius:4px;display:block}}
.aimg-small{{position:absolute;bottom:-2rem;right:-2rem;width:52%;height:200px;aspect-ratio:4/3;object-fit:cover;border-radius:4px;border:5px solid var(--bg);box-shadow:0 16px 48px rgba(0,0,0,.18)}}
...
.srv-img{{width:100%;height:210px;min-height:160px;object-fit:cover;display:block;background:var(--light)}}
...
.why-img{{width:100%;height:480px;aspect-ratio:3/4;object-fit:cover;border-radius:4px;display:block;background:var(--mid)}}
...
@media(max-width:960px){{
  #about,#services,#portfolio,#why,#testimonials,#contact{{padding:4.5rem 5%}}
  .stats-bar{{padding:2.5rem 5%}}
  .about-in,.why-in,.con-in{{grid-template-columns:1fr;gap:2.5rem}}
  ...
  .nlinks{{display:none}}
  .hbg{{display:flex}}
  .port-grid{{display:grid;grid-template-columns:1fr 1fr;grid-template-rows:repeat(3,180px);gap:8px}}
  .pi:nth-child(n){{grid-column:span 1!important}}
  .pi:nth-child(1){{grid-column:span 2!important}}
  .frow{{grid-template-columns:1fr}}
  .cform{{padding:1.6rem}}
  .ft{{flex-direction:column;gap:1.5rem}}
  .htitle{{font-size:clamp(2.2rem,10vw,3.5rem)}}
  .hsub{{font-size:.88rem}}
  .aimg-main{{height:320px}}
  .why-img{{height:320px}}
}}
@media(max-width:560px){{
  #about,#services,#portfolio,#why,#testimonials,#contact{{padding:3.5rem 4%}}
  .srv-grid,.testi-grid{{grid-template-columns:1fr}}
  .stats-grid{{grid-template-columns:1fr 1fr;gap:1rem}}
  .sn{{font-size:2.2rem}}
  .port-grid{{grid-template-columns:1fr!important;grid-template-rows:none!important;display:flex;flex-direction:column;gap:8px}}
  .pi{{height:200px!important}}
  .pi:nth-child(n){{display:block}}
  .hbtns{{flex-direction:column;align-items:center}}
  .btn-a,.btn-b{{width:100%;text-align:center;padding:.85rem 1.5rem}}
  .cform{{padding:1.2rem}}
  nav{{padding:0 4%}}
  #about,#services,#portfolio,#why,#testimonials,#contact{{padding:3rem 4%}}
...
<section id="about">
  <div class="about-in">
    <div class="aimg-wrap rv">
      <img src="{img(p['about_id'],800)}" alt="{e(name)}" class="aimg-main" loading="lazy" onerror="this.style.background='var(--light)';this.removeAttribute('src')">
      <img src="{img(p['about2_id'],500)}" alt="{e(name)}" class="aimg-small" loading="lazy" onerror="this.style.display='none'">
  ...
  <div class="services-in">
    ...
    <div class="srv-grid">
      <div class="srv-card rv">
        <img src="{img(p['srv1_id'],600)}" alt="{e(s1n)}" class="srv-img" loading="lazy" onerror="this.style.background='var(--light)';this.removeAttribute('src')">
        <div class="srv-body">
      ...
      <div class="srv-card rv d1">
        <img src="{img(p['srv2_id'],600)}" alt="{e(s2n)}" class="srv-img" loading="lazy" onerror="this.style.background='var(--light)';this.removeAttribute('src')">
        <div class="srv-body">
      ...
      <div class="srv-card rv d2">
        <img src="{img(p['srv3_id'],600)}" alt="{e(s3n)}" class="srv-img" loading="lazy" onerror="this.style.background='var(--light)';this.removeAttribute('src')">
        <div class="srv-body">
...
<section id="portfolio">
  <div class="port-in">
    ...
    <div class="port-grid">
      <div class="pi rv">
        <img src="{img(port[0],900)}" alt="{e(pl[0][1])}" loading="lazy" onerror="this.style.background='var(--mid)';this.removeAttribute('src')">
        <div class="pi-ov"><div class="pi-cap"><p>{e(pl[0][0])}</p><h4>{e(pl[0][1])}</h4></div></div>
      </div>
      <div class="pi rv d1">
        <img src="{img(port[1],700)}" alt="{e(pl[1][1])}" loading="lazy" onerror="this.style.background='var(--mid)';this.removeAttribute('src')">
        <div class="pi-ov"><div class="pi-cap"><p>{e(pl[1][0])}</p><h4>{e(pl[1][1])}</h4></div></div>
      </div>
      <div class="pi rv">
        <img src="{img(port[2],600)}" alt="{e(pl[2][1])}" loading="lazy" onerror="this.style.background='var(--mid)';this.removeAttribute('src')">
        <div class="pi-ov"><div class="pi-cap"><p>{e(pl[2][0])}</p><h4>{e(pl[2][1])}</h4></div></div>
      </div>
      <div class="pi rv d1">
        <img src="{img(port[3],700)}" alt="{e(pl[3][1])}" loading="lazy" onerror="this.style.background='var(--mid)';this.removeAttribute('src')">
        <div class="pi-ov"><div class="pi-cap"><p>{e(pl[3][0])}</p><h4>{e(pl[3][1])}</h4></div></div>
      </div>
      <div class="pi rv d2">
        <img src="{img(port[4],500)}" alt="{e(pl[4][1])}" loading="lazy" onerror="this.style.background='var(--mid)';this.removeAttribute('src')">
...
<section id="why">
  <div class="why-in">
    ...
    <div class="why-img-wrap rv d2">
      <img src="{img(p['why_id'],700)}" alt="{e(name)}" class="why-img" loading="lazy" onerror="this.style.background='var(--mid)';this.removeAttribute('src')">
      <div class="why-badge">
        <p>{e(name)}</p>
...
<section id="contact">
  <div class="con-in">
    ...
    <div class="cform rv d1">
      ...
      <form id="cf" onsubmit="this.style.display='none';document.getElementById('fs').style.display='block';return false">
        <div class="frow">
...
window.addEventListener('scroll', function(){{
  nb.classList.toggle('sc', (window.scrollY || window.pageYOffset) > 60);
}}, {{passive:true}});
if ('IntersectionObserver' in window) {{
  var obs = new IntersectionObserver(function(es){{
    es.forEach(function(el){{ if(el.isIntersecting){{ el.target.classList.add('vis'); obs.unobserve(el.target); }} }});
  }}, {{threshold:0.08}});
